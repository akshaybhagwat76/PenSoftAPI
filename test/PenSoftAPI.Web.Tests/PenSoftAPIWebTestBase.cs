...
{
    public abstract class PenSoftAPIWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static PenSoftAPIWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(PenSoftAPIWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<PenSoftAPIDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<PenSoftAPIDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<PenSoftAPIDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<PenSoftAPIDbContext, Task<T>> func)
        {
            T result;
