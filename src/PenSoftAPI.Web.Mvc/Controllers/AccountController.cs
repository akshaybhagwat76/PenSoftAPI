...
using PenSoftAPI.Sessions;
using PenSoftAPI.Web.Models.Account;
using PenSoftAPI.Web.Views.Shared.Components.TenantChange;

namespace PenSoftAPI.Web.Controllers
{
    public class AccountController : PenSoftAPIControllerBase
    {
